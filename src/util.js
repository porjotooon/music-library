    ...
    return [
        {
            ...
            artist: "MAPPA",
            audio: "./assets/Taisou Zamurai ED.mp3",
            color: ["#205950","#2ab3bf"],
            id: uuidv4(),
            active: true,
        },
        {
            ...
            artist: "MAPPA",
            audio: "./assets/Taisou Zamurai ED Piano.mp3",
            color: ["#EF8EA9","#ab417f"],
            id: uuidv4(),
            active: false,
        },
        {
            ...
            artist: "Jesper Kyd",
            audio: "./assets/Berserkir (Ezio's Family).mp3",
            color: ["#CD607D","#c94043"],
            id: uuidv4(),
            active: false,
        },
        {
            ...
            artist: "CDProjectRed",
            audio: "./assets/Kaer Morhen - Witcher 3.mp3",
            color: ["#EF8EA9","#ab417f"],
            id: uuidv4(),
            active: false,
        },
        {
            ...
            artist: "Yuki Hayashi",
            audio: "./assets/Track Meet - Yuki Hayashi.mp3",
            color: ["#CD607D","#c94043"],
            id: uuidv4(),
            active: false,
        },
        {
            ...
            artist: "Aklo",
            audio: "./assets/LOST IN PARADISE feat. AKLO.mp3",
            color: ["#205950","#2ab3bf"],
            id: uuidv4(),
            active: false,
        },
        {
            ...
            artist: "Einar Selvik",
            audio: "./assets/Nordic War Chant!.mp3",
            color: ["#205950","#2ab3bf"],
            id: uuidv4(),
            active: false,
        },
        {
            ...
            artist: "Gintama",
            audio: "./assets/Life Flows Like a Conveyor Belt.mp3",
            color: ["#CD607D","#c94043"],
            id: uuidv4(),
            active: false,
        },
